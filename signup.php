...
<body>
	...
	<div class="wrap">
		...
		<tr>
			...
			<td style="border-top:0px;"><input type="text" name="fname" class="input-block-level" pattern="[A-Za-z]{4-12} placeholder="Enter the First name" onblur="return name1()"><span id="fn"></span></td>
		</tr>
		<tr>
			<td style="border-top:0px;"> Last Name <font color=red>* </font> </td>
			<td style="border-top:0px;"><input type="text" name="lname" class="input-block-level" pattern="[A-Za-z]{4-12}" placeholder="Enter the Last name" onblur="return name12()"><span id="ln"></span></td>
		</tr>
		<tr>
...
function check123()
	{
		...
		if(c.length < 10 )
		{
			document.getElementById("ps").innerHTML="<br/><font color=red>password must be atleast 10 - 32 char long</font>";
			return false;
		}
</script>
